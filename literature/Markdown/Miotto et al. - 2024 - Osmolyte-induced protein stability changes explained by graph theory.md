...
Mattia Miotto a,∗,1, Nina Warner b,1, Giancarlo Ruocco a,c, Gian Gaetano Tartaglia d,a, 
Oren A. Scherman b,2, Edoardo Milanetti c,a,2
...
applications. While the intrinsic stability of proteins is ultimately ﬁxed by their amino acid composition and organization, the interactions between osmolytes and 
...
experimental measurements with molecular dynamics simulations and graph-theory-based analyses to predict the stabilizing/destabilizing eﬀects of diﬀerent kinds 
...
between the melting temperature 𝑇𝑚and the preferential interaction coeﬃcient deﬁned by the radial distribution functions of osmolytes and water around the 
...
a Center for Life Nano & Neuro Science, Istituto Italiano di Tecnologia, Viale Regina Elena 291, 00161, Rome, Italy
b Melville Laboratory for Polymer Synthesis, Yusuf Hamied Department of Chemistry, Lensﬁeld Road, Cambridge CB2 1EW, United Kingdom
c Department of Physics, Sapienza University, Piazzale Aldo Moro 5, 00185, Rome, Italy
d Department of Biology, Sapienza University, Piazzale Aldo Moro 5, 00185, Rome, Italy
...
standpoint, these interactions oﬀer insight into the remarkable ability of 
life itself to persist in extreme environments by osmolyte-related mech-
anisms [27,32,35,44].

Eﬀorts to explain osmolyte-induced protein stability changes have 
...
theory, originally proposed by Serge Timasheﬀ in the 1980s, attributes 
...
E-mail address: mattia.miotto@roma1.infn.it (M. Miotto).
1 These authors contributed equally to the present work.
2 These authors contributed equally to the present work.

https://doi.org/10.1016/j.csbj.2024.10.014
Received 14 August 2024; Received in revised form 7 October 2024; Accepted 8 October 2024

temperature, 𝑇𝑚. On the contrary, destabilizing osmolytes such as urea 
are believed to behave in an opposite manner, inducing a more diﬀuse 
...
were measured experimentally by intrinsic tryptophan ﬂuorescence (ITF) shifting. Simulations were analyzed from a graph-theoretical lens with respect to both 
protein residue-residue interactions and osmolyte-osmolyte interactions as well as by residue dynamics, and osmolyte preferential exclusion coeﬃcients. For more 
information, see Methods.

M. Miotto, N. Warner, G. Ruocco et al.
...
mean square ﬂuctuations (RMSFs), and protein/solvent relaxation times 
...
trimethylglycine) could reveal distinct morphological diﬀerences be-
...
morphological diﬀerences in aggregates formed by the chaotropic and 
...
found no signiﬁcant perturbations to the water network when properly 
...
tensively in a predictive context, particularly relating to the eﬀect of 
mutations on protein stability; indeed, the ﬁrst example of ab initio 
...
bility at a molecular level and the distinct morphological diﬀerences 
...
perspective [29]. As far as the authors are aware, this is the ﬁrst graph 
...
sic tryptophan ﬂuorescence, molecular dynamics (MD) simulation, and 
...
To investigate the eﬀects of osmolyte-induced protein thermal sta-
...
eﬃciency. LYS and BLG were studied by experiment and MD simula-
...
in the presence of urea. Dots represent experimental data while continuous lines represent the best-ﬁt solution of Eq. (1). b) Same as in panel a, but for BLG ITF 
unfolding curves. c) Measured melting temperatures for lysozyme in the presence of diﬀerent osmolyte concentrations. d) Same as in panel c) but for BLG’s 𝑇𝑚. See 
the Methods section for details on measurement and 𝑇𝑚calculation.
...
tryptophane exposure due to protein unfolding. Deﬁning the melting 
temperature as the one corresponding to the ﬂex of the sigmoid (see 
...
were increased, protein 𝑇𝑚followed; addition of urea, in contrast, in-
duced deleterious eﬀects on the thermal stability of both proteins as 
...
Fig. 2d). For this sample, 𝑇𝑚was approximated as 20 𝑜C (room temper-
ature).

Interestingly, the relative eﬃcacy of protecting osmolytes in raising 
protein 𝑇𝑚was found to depend on concentration. In the case of LYS, 
sucrose conferred the best stabilization at 4 and 17 wt%, however at the 
highest concentration studied (37 wt%), the eﬀects of sucrose, sorbitol, 
and trehalose on LYS’ 𝑇𝑚fell within error (Δ𝑇𝑚= ±1 𝑜C) of one another. 
...
in both cases, variance in 𝑇𝑚amongst all protecting osmolyte systems 
...
sence of heat— do not provide direct clues on the eﬀect of the diﬀerent 
...
To predict the eﬀect of osmolytes on protein thermal stability, we 
...
(BLG) in the presence of the ﬁve osmolytes used in experiments at four 
...
In this framework, we ﬁrst checked that both protein and osmolytes 
...
nor BLG showed a signiﬁcant change in structure (secondary or tertiary) 
...
ﬂect a limit of the force ﬁelds in reproducing the experimental systems’ 
...
RMSF v. 𝑇𝑚considering protecting and destabilizing (inset) osmolytes for c) LYS and d) BLG. Red dots in the plots (respectively, green) represent systems with 
...
mean RMSF and 𝑇𝑚for systems at low osmolyte concentration (4 and 
...
correlations between mean RMSF and 𝑇𝑚for both proteins were con-
...
between RMSF and 𝑇𝑚failed to extrapolate. In fact, while the correlation 
between mean RMSF and 𝑇𝑚for BLG was not signiﬁcant (R = -0.07, p-
value: 0.93, points: 4), an opposite positive correlation was observed 
between protein dynamics and 𝑇𝑚for LYS/urea systems (R = 0.77, p-
value: 0.23, points: 4) (see insets in Fig. 3c,d).

This may be related to bonding between LYS surface residues and 
urea, leading to reduced local ﬂexibility of the protein. Independent of 
origin, however, the inconsistent relationship between mean RMSF and 
𝑇𝑚confounds the interpretation of RMSF in osmolyte systems with re-
spect to protein stability. Thus, we sought a ﬁner description of the pro-
tein structural organization able to capture the eﬀect of the osmolytes.
...
sized that analyzing the RINs of 𝛽L and LYS in the presence of diﬀerent 
osmolytes may aﬀord a superior method for probing stability than con-
...
were modeled as graphs wherein nodes were deﬁned by the C𝛼atoms 
of amino acids, covalent interactions were ignored, links between (non-
adjacent) nodes existed if the distance between them was ≤9 Å, and the

4080

Computational and Structural Biotechnology Journal 23 (2024) 4077–4087

weight of each link was deﬁned by either the van der Waals or Coulom-
...
molytes led to a dampening of the correlation coeﬃcient from R = 0.82 
...
dictability of 𝑇𝑚across all osmolyte concentrations for BGL. In addition, 
...
These results suggest that mean RIN BC oﬀers an alternative descrip-
...
To check whether the stabilizing/destabilizing eﬀect of osmolytes is 
protein-dependent, we moved to consider the interaction between pro-
teins and osmolytes more directly. To this aim, we ﬁrst evaluate the 
...
mechanism. b) Mean RIN BC v. 𝑇𝑚for LYS in solutions of protecting osmolytes (left panel) and urea (right panel). c) Mean RIN BC v. 𝑇𝑚for BLG in solutions of 
...
erol and urea present well-deﬁned peaks with high proximity to the 
...
deﬁned peaks are evident at a distance ≥15 Å from the protein. These 
suggest the presence of ordered osmolyte structures around the protein 
surface.

Protein-osmolyte preferential interaction coeﬃcients were calcu-
...
teraction coeﬃcients indicate an excess of the osmolyte in the local 
domain of the protein, whilst a negative preferential interaction coeﬃ-
cient indicates exclusion of the osmolyte from the direct surroundings of 
the protein. Preferential interaction coeﬃcients for all protein-osmolyte 
systems are presented in Fig. 5c-d.

Consistent with previous ﬁndings [11,46], urea presented a positive 
preferential interaction coeﬃcient with both proteins at all concen-
trations (Fig. 5). The preferential interaction coeﬃcient characterizing 
urea/BLG was higher than that characterizing urea/LYS across all con-
centrations; this diﬀerence was most dramatic at 37 wt%, however, 
reﬂecting the relative magnitude of 𝑇𝑚depression observed amongst the 
two systems (BLG: Δ𝑇𝑚= - 65, LYS: Δ𝑇𝑚= -26). The origin of the diﬀer-
ential extent of preferential interaction amongst urea/BLG and urea/LYS 
(as well as diﬀerences amongst coeﬃcients characterizing interactions 
...
shape/topology, and preferential interaction coeﬃcients could be a fas-
...
also noted that glycerol— the least eﬀective protecting osmolyte by 
...
ential interaction coeﬃcients of all osmolyte-protein combinations were 
...
the relationship between 𝑇𝑚and preferential interaction coeﬃcient of 
...
ﬁcients and 𝑇𝑚were further disaggregated by osmolyte/protein pair; Ta-
ble 1 reports R values for the relationships between 𝑇𝑚and preferential 
interaction coeﬃcients across all ten protein/osmolyte combinations.

In all cases, the relationship between 𝑇𝑚and preferential interaction 
...
coeﬃcients were calculated (BLG/urea, BLG/trehalose, BLG/sucrose, 
and LYS/sucrose) were also characterized by the strongest correlations 
between 𝑇𝑚and preferential interaction. This suggests that when a sig-
niﬁcant diﬀerence in osmolyte preference for the local (protein) and 
...
37 wt% sucrose). Dotted vertical line marks the local (deﬁned by 𝑟 = [0, 𝑟⋆]) and distant domains ([𝑟⋆, 𝑟𝑏𝑜𝑥]). The cutoﬀ distance between the local and bulk domains, 
𝑟⋆, is selected as described in the Methods. b) Same as in panel a) but for lysozyme in the presence of urea. c) Osmolyte-protein preferential interaction coeﬃcients 
(Γ𝑜,𝑝) for all 15 simulated lysozime-osmolyte systems. c) Same as in panel c) but for BLG.

M. Miotto, N. Warner, G. Ruocco et al.

Table 1
𝑇𝑚v. Preferential Interaction 
Correlation Coeﬃcients (R) 
...
ﬁcients for both proteins of R = 0.42 (p-value of 0.02 for 30 points) 
...
protein preferential interaction coeﬃcient (see Fig. 6c-d). This relation-
ship was characterized by negative correlation coeﬃcients for both pro-
teins (R = -0.67 and -0.49 for LYS and 𝛽L, respectively), suggesting that 
preferential exclusion may be driven to a signiﬁcant extent by steric ex-
...
erential interaction coeﬃcients and mean osmolyte clique volume was
...
Coeﬃcient Correlation (R) by Concentration.

Osmolyte Concentration (wt%)
LYS
𝛽L
...
served correlation from the eﬀect of concentration (and concomitant 
eﬀect of changes to global node density), the correlation between mean 
...
peared to diﬀuse across the entirety of the simulation space with lit-
...
tended structural networks around the protein, failing to diﬀuse into 
...
(glycerol, urea) and negative (sorbitol, sucrose, trehalose) preferential interaction coeﬃcients at 37 wt%. Preferentially excluded osmolytes tend to form osmolyte-
...
where between these two morphological scenarios, reﬂective of the 
...
Two major conclusions can be drawn from this work; the ﬁrst is that 
...
and secondary/tertiary structure analysis fail to predict 𝑇𝑚with gener-
...
generalizability of this metric and to test whether, alongside oﬀering 
predictive utility, analysis of RIN BC may also oﬀer insight into the
...
signiﬁcantly interact. Thus, the relationship between the structure of 
osmolyte aggregates and protein identity is likely rooted in indirect re-
lations, e.g. via the ﬁrst hydration layer. Such an explanation would 
...
via a scaﬀolding eﬀect.

Finally, we want to stress that while the set of studied descriptors 
has the potential to be used as eﬀective predictors of the eﬀect of os-
molyte kinds/concentrations on the protein melting temperatures, the 
link to the stabilizing/destabilizing mechanisms could be aﬀected by 
the speciﬁcs of the molecular dynamics simulations we chose. In fact, 
previous works pointed out a force-ﬁeld dependence in the aggregation 
...
tryptophan ﬂuorescence using a Cary Eclipse Fluorimeter. Samples were

4084

Computational and Structural Biotechnology Journal 23 (2024) 4077–4087

excited at 295 nm (slit width = 2 nm) to avoid excitation of tyrosine. An 
...
temperature. In the case of lysozyme, the data was then ﬁt to a sig-
moidal distribution using the Boltzmann function, and 𝑇𝑚was obtained 
from x𝑜, the inﬂection point of the function,
...
moidal ﬁts. As such, thermal stability was assessed by T𝑡ℎ𝑟𝑒𝑠ℎ𝑜𝑙𝑑, the 
temperature at which a pre-determined extent of unfolding, as captured 
by the ratio of I350/I320 was reached. T𝑡ℎ𝑟𝑒𝑠ℎ𝑜𝑙𝑑was chosen based on 
...
trieved from the Protein Data Bank [5]. In addition, ﬁve osmolyte 
...
To ﬁx concentration we constructed a dodecahedral box so that each 
atom of the protein structures was at a distance of at least 1.1 nm from 
the nearest box face. We ﬁlled one copy of the box with only water 
molecules and another copy with only molecules of an osmolyte; we 
call 𝑤the ratio between the number of water molecules (𝑊𝑀) and the 
...
where 𝑤is the concentration, 𝑁is the ﬁnal number of osmolyte 
molecules and 𝑛is the ﬁnal number of water molecules.

We can write a system of two equations, where the ﬁrst equation is 
(2), while the second equation is obtained by considering that in the 
absence of an osmolyte, we have 𝑊𝑀water molecules and that each 
molecule replaces 𝑟water molecules, therefore
...
the system were built using the CHARMM-27 force ﬁeld [9]. The protein 
was placed in a dodecahedral simulative box, with periodic boundary 
conditions, ﬁlled with TIP3P water molecules [24]. The 2YVB and 3BLG
systems were neutralized with 8 Cl atoms and 9 Na atoms respectively. 
We chose the CHARMM27 force ﬁeld and TIP3P water model; we ob-
tained the force ﬁeld parameters of the osmolytes from SwissParam 
...
kept constant at 300 K with v-rescale thermostat [10]; the ﬁnal pressure 
was ﬁxed at 1 bar with the Parrinello-Rahman barostat [41].
...
gen atoms. A cut-oﬀ of 12 Å was imposed for the evaluation of short-
...
rameters obtained from the CHARMM force ﬁeld. In particular, given 
two atoms 𝑎𝑙and 𝑎𝑚holding partial charges 𝑞𝑙and 𝑞𝑚, the Coulombic 
...
where 𝑟𝑙𝑚is the distance between the two atoms, and 𝜖0 is the vacuum 
...
where 𝜖𝑙and 𝜖𝑚are the depths of the potential wells of 𝑎𝑙and 𝑎𝑚re-
spectively, 𝑅𝑙
𝑚𝑖𝑛and 𝑅𝑚
𝑚𝑖𝑛are the distances at which the potentials reach 
their minima.
...
where 𝐸𝑋
𝐴𝐴𝑖𝑗is the energy between two amino acids 𝑖and 𝑗, obtained

as the sum of the interactions between each atom of the two residues 
(𝑁𝑖
𝑎𝑡𝑜𝑚, 𝑁𝑗
𝑎𝑡𝑜𝑚); 𝑋stands for the kind of interaction considered, either 
...
other residues, with water molecules, and with osmolytes.
...
ticles corresponding to the bin deﬁned by (r, dr), respectively; r is the 
...
(adapted from [46]). The cutoﬀ distance marking the boundary between 
...
eled as residue interaction networks (RINs) wherein residue C𝛼atoms 
...
Cliques were deﬁned as complete subgraphs wherein a link existed 
...
wherein the 𝐵𝐶(𝑣) is the betweenness centrality of node 𝑣, 𝑛is the num-
ber of nodes in the graph, (𝑠, 𝑡) represents each pair of vertices, 𝜎𝑠𝑡is the 
...
the centrality or importance of a node within a network. It reﬂects the 
...
of nodes in the graph. Nodes with high betweenness centrality are cru-
cial for maintaining eﬃcient communication and connectivity within 
...
as a bridge or intermediary between diﬀerent parts of the graph. Nodes 
...
We declare no conﬂict of interests for the present manuscript.
...
Innovation Council through its Pathﬁnder Open Programme, project 
ivBM-4PAP (grant agreement No 101098989). N.W. and O.A.S thank 
AB Agri for ﬁnancial support.
...
[1] Adamczak Beata, Kogut Mateusz, Czub Jacek. Eﬀect of osmolytes on the thermal 
...
[3] Arakawa T, TimasheﬀSN. The stabilization of proteins by osmolytes. Biophys J 
...
dra. Contrasting eﬀects of guanidinium chloride and urea on the activity and unfold-
...
[11] Canchi Deepak R, García Angel E. Cosolvent eﬀects on protein stability. Annu Rev 
...
ancarlo. Spatial organization of hydrophobic and charged residues aﬀects protein 
thermal stability and binding aﬃnity. Sci Rep July 2022;12(1).
[14] Dong Yun-wei, Liao Ming-ling, Meng Xian-liang, Somero George N. Structural 
ﬂexibility and protein adaptation to temperature: molecular dynamics analysis 
...
Acosta Gianco. Classiﬁcation of conformational stability of protein mutants from 
...
Zaslavsky Boris Y. Analyzing the eﬀects of protecting osmolytes on solute–water 
...
[19] Gekko Kunihiko, TimasheﬀSerge N. Mechanism of protein stabilization by 
...
1997;18(12):1463–72.
[24] Jorgensen William L, Chandrasekhar Jayaraman, Madura Jeﬀry D, Impey Roger W, 
...
2010;62(12):891–5.
[28] Kuﬀel Anna, Zielkiewicz Jan. The hydrogen bond network structure within the hy-
dration shell around simple osmolytes: urea, tetramethylurea, and trimethylamine-
N-oxide, investigated using both a ﬁxed charge and a polarizable water model. 
...
[31] Lerbret A, Bordat P, Aﬀouard F, Hédoux A, Guinet Y, Descamps M. How do tre-
halose, maltose, and sucrose inﬂuence some structural and dynamical properties 
of lysozyme? Insight from molecular dynamics simulations. J Phys Chem B August 
2007;111(31):9410–20.
[32] Lin Tiao-Yin, TimasheﬀSerge N. Why do some organisms use a urea-methylamine 
...
moud, Doustdar Farahnoosh. Eﬀects of osmolytes on the helical conforma-
...
parzadeh Nader. Eﬀect of sorbitol and glycerol on the stability of trypsin and dif-
ference between their stabilization eﬀects in the various solvents. Biotechnol Appl 
...
of preferential interaction coeﬃcients of proteins. J Phys Chem B September 
...
[49] Sundar Smrithi, Sandilya Avilasha A, Priya M Hamsa. Unraveling the inﬂuence of 
...
[50] TimasheﬀSN. Control of protein stability and reactions by weakly interacting cosol-
vents: the simplicity of the complicated. Adv Protein Chem 1998;51:355–432.
[51] TimasheﬀSerge N. Water as ligand: preferential binding and exclusion of denatu-
rants in protein unfolding. Biochemistry October 1992;31(41):9857–64.
[52] TimasheﬀSerge N. Protein hydration, thermodynamic binding, and preferential hy-
dration. Biochemistry November 2002;41(46):13473–82.
[53] TimasheﬀSerge N. Protein-solvent preferential interactions, protein hydration, and 
...
E, Berendsen Herman JC. GROMACS: fast, ﬂexible, and free. J Comput Chem 
2005;26(16):1701–18.
...
Param: a fast force ﬁeld generation tool for small organic molecules. J Comput Chem 
2011;32(11):2359–68.